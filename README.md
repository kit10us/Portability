...
# Portability Library
Portability Library (Port) is a general-purpose C++ library designed to standardize functionality across multiple platforms.

# Port Philosophy
Port achieves its goals through several architectural pillars:
...
```
cmake --build build --config Debug --target port_unit_tests
```
...
## Executing Test
Port utilizes ctest to execute unit testing.
